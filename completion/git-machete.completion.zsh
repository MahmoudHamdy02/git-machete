  ...
  case $state in
    (command)
      ...
      github_subcommands=(
        ...
        'sync:synchronize with the remote repository: delete untracked and unmanaged branches with no downstream branch and also checkout open PRs for the current user associated with the Github token'
      )
